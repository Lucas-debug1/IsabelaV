...
function abrirNicho(id) {
  ...
  modalContent.innerHTML = `
    ...
    <div class="modal-cta">
      <a href="https://api.whatsapp.com/send/?phone=55818194780616&text=Ol%C3%A1%21+Tenho+interesse+nos+criativos+de+Advocacia&type=phone_number&app_absent=0${encodeURIComponent(n.nome)}" target="_blank" class="modal-btn-wp">
